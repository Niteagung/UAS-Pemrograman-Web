        ...
        <main class="bg-light">
            <div class="p-2">
                ...
                <nav class="px-3 py-2 bg-white rounded shadow">
                    <h class="fw-bold mb-0">Master Barang - Jenis</h>
                </nav>  
            </div>
                <!-- end: Navbar -->
            <div class="container">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                 <!-- Button to Open the Modal -->
                                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?=$idjenis;?>">
                                                    Edit
                                                </button>
                                                <input type = "hidden" name="idjenishapus" value="<?=$idjenis;?>">
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?=$idjenis;?>">
                                                    Delete
                                                </button>
                                            </td>
                                        </tr>
                                         ...
                                         <!-- The Edit Modal -->
                                            <div class="modal fade" id="edit<?=$idjenis;?>">
                                                ...
                                                <input type="text" name="namajenis" value="<?=$namajenis;?>" class="form-control" required > <!--required: validasi agar data kosong yang tersubmit tidak tersimpan di dalam database-->
                                                <br>
                                                <input type="text" name="keterangan" value="<?=$keterangan;?>" class="form-control" required>
                                                <br>
                                                <input type="hidden" name="idjenis" value="<?=$idjenis;?>"><!-- passing --> 
                                                <button type="submit" name="updatejenis" class="btn btn-primary">Submit</button>
                                                </div>
                                                </form>
                                            ...
                                            <!-- The Delete Modal -->
                                            <div class="modal fade" id="delete<?=$idjenis;?>">
                                                <div class="modal-dialog">
                                                <div class="modal-content">
                                                ...
                                                <br>
                                                <br>
                                                <button type="submit" name="hapusjenis" class="btn btn-danger">Hapus</button>
                                                </div>
                                                </form>
    ...
    <div class="modal" id="myModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post">
                <div class="modal-body">
                    <input type="text" name="namajenis" placeholder="Nama Jenis" class="form-control" required>
                    <br>    
                    <input type="text" name="keterangan" placeholder="Keterangan" class="form-control" required>
                    <br>
                    <button type="submit" name="addnewjenis" class="btn btn-primary">Submit</button>
                </div>
                </form>
            </div>
        </div>
