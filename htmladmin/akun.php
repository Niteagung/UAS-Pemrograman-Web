             ...
             <div class="card">
                ...
                Tambah Pengguna
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>                    
                        <?php
                                        $ambilsemuadataakun = mysqli_query($conn, "SELECT * FROM akun");
                                        $i = 1;
                                        while($data = mysqli_fetch_array($ambilsemuadataakun)){
                                            $iduser = $data['iduser'];
                                            $username = $data['username'];
                                            $email = $data['email'];
                                            $passwordakun = $data['passwordakun'];
                                        ...
                                        <tr>
                                         ...
                                         <!-- The Edit Modal -->
                                            <div class="modal fade" id="edit<?=$iduser;?>">
                                                ...
                                                <input type="text" name="username" value="<?=$username;?>" class="form-control" required > <!--required: validasi agar data kosong yang tersubmit tidak tersimpan di dalam database-->
                                                <br>
                                                <input type="text" name="email" value="<?=$email;?>" class="form-control" required>
                                                <br>
                                                <input type="text" name="passwordakun" value="<?=$passwordakun;?>" class="form-control" required>
                                                <br>
                                                <input type="hidden" name="iduser" value="<?=$iduser;?>"><!-- passing --> 
    ...
    <div class="modal" id="myModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post">
                <div class="modal-body">
                    <input type="text" name="username" placeholder="Nama Akun" class="form-control" required>
                    <br>    
                    <input type="text" name="email" placeholder="Email" class="form-control" required>
                    <br>    
                    <input type="text" name="passwordakun" placeholder="passwordakun" class="form-control" required>
                    <br>
